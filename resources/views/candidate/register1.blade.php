                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="qual_list">
                                <tr>
                                    ...
                                    <td>{!! Form::select('qualifications[1][idMedium]',getMedium() ,null, ['class' => 'form-control select2','style'=>'width:100px;','required'=>'required']) !!}</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 4px solid #f4f4f4;">
                                            ...
                                            echo '<textarea name="questions['.$value->idQuestion.']" rows="4" cols="70" placeholder="  Reason for choosing"></textarea>';}?>
                                            @foreach($qans as $a)
                                            @if($value->idQuestion == 4)
                                                <input type="{{$value->questionType}}" name="question[{{$a->idOption}}]" value="{{$a->idOption}}" id="que_{{$value->idQuestion}}{{$a->optionValue}}" >
