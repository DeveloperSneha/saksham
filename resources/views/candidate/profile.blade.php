...
<div class="panel panel-default">
    <div class="panel-heading">View Profile : <span class="font-semibold">{{ $candidate->firstName }} {{ $candidate->lastName }}</span></div>
    <div class="panel-body" style="margin-top: 10px!important;">        
        ...
        <div class="candidate_info1">
            <ul>
                ...
                <li>
                    ...
                    <p>{{$candidate->pan or ''}}</p>
                </li>
                <li>
                    <h4><strong>Pin Code</strong></h4>
                    <p>{{$candidate->tempPincode or ''}}</p>
                </li>
            </ul>
        </div>
        <div class="candidate_info1">
        ...
        <table class="table table-bordered"  style="text-align:center;">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$i}}</td>
                    <td>{{$val->qualification->qName or ''}}</td>
                    <td>{{$val->university->universityName or ''}}</td>
                    <td>{{$val->percentage or ''}}%</td>
                    <td>{{$val->passedYear or ''}}</td>
                    <td>{{ucwords($val->medium->mediumName) or ''}}</td>
                </tr>
                <?php $i++;?>
                @endforeach
            </tbody>
        ...
        @endif
        @if(count($candidate->candidate_answer)>0)
