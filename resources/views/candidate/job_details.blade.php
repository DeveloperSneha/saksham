...
<div class="panel panel-default">
    <div class="panel-heading">Job Details : <span class="font-semibold"> </span></div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="profile_expertise_txt profile_right" style="padding:5px;">
                            <ul>
                                <li>
                                    <span>@foreach($job_details->job->joblocation as $loc) {{$loc->district->districtName}} <br>@endforeach</span>
                                </li>
                            </ul>
                        </div>
                    </li>
                    @if($job_details->job->actualLocation)
                    <li>
                        <div class="profile_expertise profile_left" style="padding:5px;">
                            <h4 style="font-weight: 600;">Actual Location</h4>
                        </div>
                        <div class="profile_expertise_txt profile_right" style="padding:5px;">
                            <ul>
                                <li>
                                    <span>{{$job_details->job->actualLocation}}</span>
                                </li>
                            </ul>
                        </div>
                    </li>
