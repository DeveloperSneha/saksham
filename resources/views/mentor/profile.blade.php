...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="margin-top: 10px!important;">        
        ...
        <table border="4px" id="detail_table" class="table table-bordered" style="background: lightgray;">
                ...
                <tr>
                    <td style="text-align:center;font-size: 18px;font-weight: 600;width: 35%">About</td>
                    <td>{{$mentor->about}}</td>
                </tr>
                <tr>
                    <td style="text-align:center;font-size: 18px;font-weight: 600;width: 35%">Headline</td>
