...
<?php $mentor =\App\Mentor::where('idMentor','=',Auth::guard('mentor')->user()->idMentor)->first();?>
                ...
                <div class="chat_main_div">
                    <div class="chat_left">
                        <ul class="user_side_bar">
                            ...
                            ?>
                                @if($var->idCandidate == $candidate->idCandidate)
                                <li style="background:linear-gradient(to right, rgb(0, 162, 141), rgb(71, 210, 182),rgb(68, 152, 183));">
                                ...
                                <li style="background:linear-gradient(to right, rgb(3, 99, 87), rgb(3, 130, 106),rgb(2, 73, 99));">
                                    <a href="{{url('/mentor/chat/'.$var->idCandidate.'')}}" style="color: white;">@if(!empty($var->candidate->image))
                                        <img src="{{$var->candidate->image}}" style="    width: 45px;height: 45px;border-radius: 50%;text-align: center;line-height: 2.7;background: #efefef;display: inline-block;vertical-align: top;margin-right: 10px;color: #fff;">
                                    @else
                                    <span class="fas fa-user"></span>
                                    @endif
                    ...
                    <div class="chat_right">
                        <div class="chat_box_div">
                            <div class="chat_box">
                                <h2>Chatting with {{$candidate->firstName}} {{$candidate->lastName}}</h2>
                                <ul class="messages_section">
                                    ...
                                    <li class=" right">
                                        ...
                                        <div class="message">
                                            ...
                                            <img src="{{$candidate->image}}" style="    width: 45px;height: 45px;border-radius: 50%;text-align: center;line-height: 2.7;background: #efefef;display: inline-block;vertical-align: top;margin-right: 10px;color: #fff;">
                                            @else
                            ...
                            {!! Form::open(['method' => 'POST',  'action' => ['Mentor\MentorController@saveChat',$candidate->idCandidate], 'class' => 'form-horizontal']) !!}
